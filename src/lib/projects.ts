...
export const projects: Project[] = [
  {
    ...
    title: "쌍용 C&E",
    client: "쌍용 C&E",
    category: "쌍용 C&E 차세대 ERP 시스템 구축",
...
GROUP  BY TRUNC(s.sale_dt), s.region_cd, p.product_grp;`,
  ...
  },
  {
    ...
    category: "Global Tax Free 대시보드 구축",
  ...
  },
  {
    ...
    title: "현대자동차 인도",
    client: "현대자동차 인도 법인",
    category: "현대자동차 인도 법인 DC4M 태블로 대시보드 구축",
  ...
  },
  {
    ...
    title: "아모레퍼시픽",
    client: "아모레퍼시픽",
    category: "아모레퍼시픽 오산 디지털 워룸 대시보드 개발",
