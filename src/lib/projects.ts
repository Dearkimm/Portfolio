...
export const projects: Project[] = [
  {
    ...
    team: "5명",
    stack: ["Tableau", "Oracle SQL", "TabPy", "ERP", "전사"],
...
GROUP  BY TRUNC(s.sale_dt), s.region_cd, p.product_grp;`,
  ...
  },
  {
    ...
    category: "외국인 환급 데이터 분석 대시보드",
    period: "2024.12 — 2025.03",
    year: "2025",
    role: "BI Data Analyst",
    team: "2명",
    stack: ["Tableau", "Figma", "Excel"],
    data: ["이용 고객 정보", "업종·매장별 결제 이력", "방문 상권 및 시간"],
    ...
    sections: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            title: "대시보드 개발",
            bullets: [
              "14본 보고서형 글로벌 Tableau 대시보드 개발 참여 (태블로 Desktop의 언어 전환 기능 한계로 영문 버전 7본 전체 재제작)",
          ...
          },
          {
            ...
            bullets: [
              ...
              "프로젝트 종료 후 고객사 대상 Tableau 핸즈온 세션에 보조 진행자로 참여 (참여자 12명 / 담당자 응대 항목 전원 '매우 만족' / 전반적 만족도 91.6% 긍정)",
            ],
          },
        ],
      },
  ...
  },
  {
    ...
    role: "BI Data Analyst",
    team: "2명",
    stack: ["Tableau", "MySQL", "Python", "GA4", "ERP"],
    data: ["회원 정보", "상품 정보", "주문 이력", "쿠폰/마일리지 사용"],
        ...
        items: [
          ...
          },
          {
            ...
            bullets: [
              ...
              "데이터 분포를 고려해 R·F·M 각 기준값을 고객사와 협의 후 확정, RFM 점수 산출 및 10개 세그먼트 분류 로직 설계",
            ],
          },
          {
            number: "03",
